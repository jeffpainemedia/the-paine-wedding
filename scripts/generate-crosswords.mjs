...
// ---------------------------------------------------------------------------
// CLUE_OVERRIDES — curated playful clues (Mini-crossword tone).
// These override existing FILL_CLUES entries for a warmer, faster feel.
// Words already in WORD_CLUES (wedding-specific entries) won't be affected
// since getClue() checks WORD_CLUES first.
// ---------------------------------------------------------------------------
const CLUE_OVERRIDES = {
  ABIDE:"Put up with, as a chaotic group chat",
  ABODE:"\"Home sweet home\" spot",
  ABOVE:"Higher up, literally",
  ABS:"Beach photo muscles, jokingly",
  ADOBE:"Photoshop's corporate cousin",
  ADORE:"Love an unreasonable amount",
  AGAIN:"One more time, with feeling",
  AGE:"Get older",
  AGENT:"Rep with a client list",
  AGGIE:"A and M loyalist",
  AGILE:"Quick on your feet",
  AGREE:"Be on the same page",
  AHEAD:"Out in front",
  ALERT:"Definitely not asleep at the wheel",
  ALGAE:"Pond gunk, basically",
  ALIKE:"Pretty much the same",
  ALIVE:"Not just existing, really living",
  ALLOT:"Give out a portion of",
  ALLOW:"Give the green light",
  ALONE:"Flying solo",
  ALOUD:"Said so everyone can hear",
  ALSO:"\"Oh, and one more thing...\"",
  ALT:"Keyboard key near the space bar",
  ALTAR:"Where the aisle is headed",
  ALTER:"Change up",
  AMONG:"In the mix",
  AMUSE:"Get a laugh out of",
  ANGER:"Steam out the ears feeling",
  ANGLE:"Photo pose, maybe",
  APES:"Copies exactly",
  APRIL:"Month that loves a shower",
  ARCH:"Curved entryway",
  ARDOR:"Hot and bothered devotion",
  ARENA:"Big game venue",
  ARGON:"Gas in a glowing sign",
  ARGUE:"Have words",
  ARID:"Bone dry",
  ARISE:"Get up, old school style",
  ARRAY:"Nicely arranged lineup",
  ARROW:"Cupid classic",
  ASANA:"Yoga pose",
  ASHEN:"Pale as a ghost",
  ASIDE:"Off to one side",
  ASKED:"Popped the question, for one",
  ASSET:"Big plus",
  ATONE:"Make up for",
  AUDIT:"Official once over",
  AVAIL:"Use to your benefit",
  AVOID:"Steer clear of",
  BAR:"Open one at the reception",
  BAT:"Baseball swinger",
  BEER:"Open bar pick",
  BEGAN:"Got the ball rolling",
  BEING:"Existing thing",
  BELOW:"Underneath",
  BET:"\"For sure,\" in slang",
  BIBLE:"Book with a whole lot of underlining",
  BLEAK:"Cheerless and gray",
  BLUSH:"Get pink in the cheeks",
  BOUND:"Headed for",
  BRAND:"Name with a logo",
  BRAVE:"Scared but doing it anyway",
  BRIDE:"The one in white",
  BROW:"Part above an eye",
  BUGLE:"Brassy wake-up call",
  BUS:"Big people mover",
  CABIN:"Cozy woods getaway",
  CAP:"Put a lid on",
  CAR:"Road trip ride",
  CARGO:"Stuff in transit",
  CAROL:"Holiday singalong",
  CARRY:"Haul around",
  CATCH:"Bouquet ___",
  CENT:"Tiny bit of change",
  CHARM:"Secret sauce in human form",
  CHESS:"Board game with bishops and queens",
  CHILI:"Bowl with a kick",
  CLEAR:"Like a really good Texas sky",
  CLONE:"Exact copy",
  COCOA:"Hot chocolate starter",
  CORAL:"Pinkish orange shade",
  COVET:"Want with grabby eyes",
  CRAB:"Beach creature with an attitude",
  CRUST:"Pizza's outer edge",
  DAD:"Father figure",
  DAM:"River blocker",
  DANCE:"What the good shoes are for",
  DARE:"Go for it",
  DARTS:"Pub game with sharp little missiles",
  DASH:"Quick sprint",
  DAY:"September 26, for you two",
  DAZED:"A little out of it",
  DEAN:"Campus bigwig",
  DEBUT:"First appearance",
  DEED:"Act, or a paper with legal weight",
  DEER:"Woodsy hoofed friend",
  DELL:"Small shady valley",
  DELVE:"Dig into",
  DEN:"Cozy little room",
  DENY:"Say \"nope\" to",
  DODGE:"Move out of the way",
  DOTE:"Be totally gone for",
  DRAMA:"Big feelings onstage",
  DREW:"Sketched out",
  DROVE:"Put miles on the odometer",
  DYE:"Give some color to",
  EAGER:"Very ready to go",
  EAGLE:"Bird with serious presence",
  EAR:"Thing that catches the gossip",
  EARLY:"Before everyone else gets there",
  EASE:"Make less stressful",
  EAST:"Sunrise direction",
  EATEN:"Already had for dinner",
  EAVES:"Roof parts that stick out",
  EDGE:"Borderline",
  EDGED:"Trimmed or bordered",
  EEL:"Slippery swimmer",
  EERIE:"Creepy in a fun way",
  EGAD:"Old-timey \"whoa\"",
  ELBOW:"Pointy arm joint",
  ELDER:"Older and wiser person",
  ELK:"Oversized deer",
  ELSE:"Other than that",
  ELVES:"Santa's little workforce",
  EMAIL:"Inbox occupant",
  ENACT:"Put into effect",
  END:"Finish line",
  ENDED:"Wrapped up",
  ENDS:"Loose bits at the tips",
  ENSUE:"Happen next",
  ENTER:"Come on in",
  ENTRY:"Way in, or what you submit",
  ERA:"Chapter of life",
  ERASE:"Wipe clean",
  ERR:"Make a little oops",
  ERROR:"Bigger oops",
  ESS:"The hissy letter",
  ETA:"Arrival estimate, briefly",
  EVENS:"Levels out",
  EVENT:"Thing on the calendar",
  EVOKE:"Bring to mind",
  EWE:"Woolly mama",
  EXCEL:"Do ridiculously well",
  EXTRA:"A little bonus",
  EYE:"Face feature that says a lot",
  FAD:"Hot thing for about five minutes",
  FEAST:"Meal worth unbuttoning for",
  FEE:"Little extra charge",
  FERAL:"Wild in every sense",
  FIRST:"How the story starts",
  FLIT:"Move quickly and lightly",
  FOUND:"Came across",
  FRAME:"Border around the memory",
  FROM:"Starting point word",
  FULLY:"Completely, no notes",
  FUSE:"Join together",
  GAUGE:"Take a measure of",
  GEAR:"Stuff you bring along",
  GENIE:"Wish granter",
  GLEE:"Pure delight",
  GLIDE:"Move like it is easy",
  GLINT:"Tiny flash of shine",
  GOING:"On the move",
  GRAIN:"Tiny seed, or wood pattern",
  GRANT:"Give officially",
  GREET:"Say hi to",
  GROVE:"Small stand of trees",
  GUARD:"Keep watch over",
  GUTSY:"Bold in a way people notice",
  HAM:"Actor who really goes for it",
  HAVEN:"Safe cozy place",
  HAZEL:"Eye color with range",
  HENCE:"So then",
  HER:"Ashlyn, in a sentence",
  HERE:"Right where you are",
  HEY:"Very casual hello",
  HILLS:"Arbor ___, proposal spot",
  HONOR:"Big respect",
  HOSE:"Backyard spray helper",
  HOTEL:"Out of town guest need",
  HURRY:"Move it",
  IDEAL:"Pretty much perfect",
  IMAGE:"Picture, in a broad sense",
  IRATE:"Mad mad",
  IRON:"Smooth out a wrinkle",
  IRONY:"Of course that happened",
  IVORY:"Soft wedding white",
  JESUS:"Center of it all, for you two",
  JOT:"Quick little note",
  KEN:"Range of what one knows",
  LABEL:"Sticker with a name on it",
  LAD:"Young guy",
  LARGE:"Not exactly petite",
  LAST:"Final one",
  LATER:"Not now, but soon enough",
  LAUGH:"Lose it a little, in a good way",
  LAY:"Set down gently",
  LEAF:"Tree piece",
  LEAP:"Jump with some commitment",
  LEGAL:"Above board",
  LEND:"Loan out",
  LET:"Allow",
  LEVEL:"Nice and even",
  LIT:"Glowing, or slangily excellent",
  LIVED:"Had real experience with",
  MANGO:"Sweet tropical fruit",
  MANOR:"Big fancy house",
  MEAN:"Average, not rude",
  MEDIA:"Press and content, collectively",
  MEET:"Come face to face",
  MEGAN:"Friend in on the proposal surprise",
  MEND:"Fix back up",
  MERIT:"Deserve",
  MESA:"Flat-topped rise",
  MET:"Came across at last",
  META:"Self-aware in an internet way",
  MILES:"Long distance tax",
  MOP:"Floor cleanup tool",
  MOVED:"Hit right in the feelings",
  NEED:"Cannot do without",
  NEON:"Sign gas with glow",
  NET:"After deductions",
  NEVER:"Not once",
  NEWS:"What is going on",
  NEWT:"Tiny pond dweller",
  NIGHT:"Proposal ___, for one",
  NOVEL:"Book, or fresh and new",
  NURSE:"Hospital pro",
  NUT:"Small crunchy snack",
  OAKEN:"Made of oak",
  OASIS:"Welcome desert spot",
  OBOE:"Woodwind with a nasal little voice",
  ODDER:"More strange",
  OLIVE:"Muted green with dinner table energy",
  ONSET:"Beginning of",
  OPERA:"Sung drama",
  OPTIC:"Related to sight",
  ORDER:"Put in sequence",
  OUTDO:"Beat at their own game",
  PAINT:"Coat with color",
  PAST:"Already happened",
  PAUSE:"Brief little stop",
  PEACE:"Calm you can feel",
  PEG:"Tiny fastener",
  PET:"Spoiled animal roommate",
  PLACE:"Spot on the map",
  PLANT:"Thing you water and hope for the best",
  PLAZA:"Open public square",
  PLEAT:"Neat fold in fabric",
  PLUMP:"Round and full",
  POLAR:"Like a bear in the Arctic",
  POLKA:"Dot pattern, or a dance",
  POSED:"Held still for the camera",
  POUND:"Hit hard",
  PRIDE:"Satisfied glow",
  PRIME:"Best possible moment",
  PRIZE:"Thing worth winning",
  PROBE:"Look into",
  PROD:"Poke to get moving",
  PROSE:"Writing that is not poetry",
  PROUD:"Absolutely beaming",
  PROVE:"Show for real",
  PUFF:"Quick little burst of air",
  RAD:"Cool, in throwback slang",
  RADIO:"Dashboard audio source",
  RAINY:"Like a day made for movies inside",
  RAISE:"Lift a glass",
  RALLY:"Come together strong",
  RANT:"Go off for a minute",
  RAP:"Quick knock",
  RAPT:"Totally locked in",
  RARE:"Not easy to find",
  RASH:"Too fast, not enough thought",
  RAVEN:"Jet black bird",
  RAY:"Bit of sunshine",
  REACH:"Stretch for",
  READY:"The dream by late September",
  REAL:"Not fake, not filtered",
  REBEL:"Rule breaker",
  RED:"Classic bold color",
  REEF:"Coral ridge",
  REEL:"Movie roll, or wobble",
  REF:"Game official, briefly",
  REGAL:"Fit for a queen",
  REIN:"Steering strap",
  RELY:"Count on",
  RENEW:"Make fresh again",
  RENT:"Pay to stay",
  REPEL:"Drive away",
  RESET:"Start over clean",
  REST:"Take five",
  RIB:"Tease a little",
  RIDGE:"Long narrow rise",
  RINGS:"Two circles, one giant promise",
  RISEN:"Come up",
  ROAM:"Wander around",
  ROE:"Fish eggs on a menu",
  ROGUE:"Loose cannon type",
  ROMAN:"Groomsman with an empire-sized name",
  ROUND:"One full lap, or a shared order at the bar",
  ROUTE:"Way to get there",
  ROYAL:"Very crown coded",
  RULER:"Desk drawer straightedge",
  RURAL:"Not city at all",
  RYE:"Bread grain",
  SAD:"Blue, basically",
  SAGE:"Wise one",
  SAINT:"Very good soul",
  SALON:"Hair appointment destination",
  SALT:"Table shaker staple",
  SAT:"Took a seat",
  SATE:"Fill completely",
  SATIN:"Glossy formal fabric",
  SAW:"Cutting tool, or noticed",
  SCAM:"Shady scheme",
  SCAR:"Old mark",
  SCENE:"Whole vibe",
  SCONE:"Coffee shop baked good",
  SCOOP:"Get the inside story",
  SCOPE:"Full extent",
  SCOUT:"Go check it out first",
  SCUM:"Pond grossness",
  SEAR:"Brown fast in a pan",
  SEE:"Take in with the eyes",
  SELL:"Part with for cash",
  SERIF:"Tiny font flourish",
  SEVEN:"Lucky number, supposedly",
  SEW:"Work the needle",
  SHADE:"Cover from the sun",
  SHALE:"Layered rock",
  SHAM:"Fake deal",
  SHAME:"That \"oof\" feeling",
  SHARE:"Marriage requires a lot of this",
  SHED:"Let go of",
  SHONE:"Sparkled, once",
  SHORE:"Water's edge",
  SIGHT:"Something worth seeing",
  SILL:"Window ledge",
  SINEW:"Tough connective stuff",
  SIXTH:"After fifth",
  SLAM:"Shut hard",
  SLANT:"Lean to one side",
  SLATE:"Blue-gray, in your palette",
  SLAW:"Crunchy picnic side",
  SLAY:"Absolutely crush it",
  SLED:"Snow day ride",
  SLEW:"Whole bunch",
  SLUMP:"Rough patch",
  SMILE:"Requirement in every good engagement photo",
  SMOKE:"Grill signal",
  SOAR:"Go way up",
  SOLAR:"Sun powered",
  SOLID:"Dependable and strong",
  SPA:"Place for a robe and cucumber water",
  SPAR:"Practice fight",
  SPELL:"Word magic, maybe",
  SPEND:"Use up, as time or money",
  SPORE:"Tiny reproductive bit",
  SPREE:"Shopping tear",
  STAB:"Jab sharply",
  STAGE:"Band setup zone",
  STAKE:"Pointed wooden post",
  STAR:"Shiny one up above",
  STARE:"Look a little too long",
  STATE:"Texas, always and forever",
  STEAL:"Take without asking",
  STEEP:"Not a casual incline",
  STILL:"Even now",
  STIR:"Mix up, or emotionally move",
  STONE:"Ring setting resident, maybe",
  STORE:"Put away for later",
  STORM:"Weather with drama",
  STRAP:"Fastening band",
  STRAW:"Sipper in a cup",
  STRAY:"Wander off course",
  STUB:"Tiny leftover bit",
  STUD:"Handsome guy, casually",
  SUAVE:"Smooth in a movie way",
  SUGAR:"Sweet stuff",
  SUPER:"Way beyond fine",
  SURGE:"Big sudden rush",
  SWAB:"Little cleaner on a stick",
  SWAG:"Confidence, or free event stuff",
  SWAP:"Trade places",
  SWAT:"Smack away",
  TAB:"What you ask for at the end",
  TABLE:"Reception furniture hero",
  TAG:"Little label",
  TARDY:"Running late",
  TEAR:"Drop from a happy cry, maybe",
  TEASE:"Mess with, but lovingly",
  TEE:"Golf ball perch",
  TEN:"Two hands' worth",
  TEND:"Take care of",
  TENSE:"Tight with nerves",
  THAT:"The one over there",
  THREE:"One more than two",
  THROW:"Bouquet ___",
  TIARA:"Princessy headpiece",
  TILT:"Lean a little",
  TIMED:"Clocked",
  TIMER:"Kitchen countdown thing",
  TIMID:"Shy side of the room",
  TITAN:"Absolute giant",
  TITLE:"Official name",
  TODAY:"This very day",
  TOKEN:"Small symbol of something bigger",
  TONGS:"Salad pinchers",
  TRACE:"Follow faintly",
  TRADE:"Swap out",
  TRAIL:"Path through the woods",
  TRAIN:"Dress detail that trails behind",
  TRASH:"Straight to the bin",
  TREAD:"Step carefully",
  TREE:"Arbor Hills resident",
  TREND:"What everyone's suddenly into",
  TRIED:"Gave it a shot",
  TRUCK:"Big road beast",
  TRUTH:"What lasts",
  TRY:"Give it a shot",
  TUB:"Bath time vessel",
  TUNED:"Adjusted just right",
  ...
  UPSET:"Not having a great time",
  URBAN:"City based",
  USAGE:"How something gets used",
  ...
  VINES:"Proposal dinner spot, minus the 60",
  VIOLA:"Instrument between violin and cello",
  VIRAL:"Everywhere all at once online",
  WAFT:"Drift through the air",
  WATER:"What every guest will need in Texas",
  WAVER:"Go back and forth",
  WEAN:"Ease away from",
  WEAVE:"Thread together",
  WED:"Get married",
  WEE:"Tiny little",
  ...
  WHOLE:"What the right person can make you feel",
  WIDEN:"Make broader",
  WIRE:"Thin metal line",
  WOE:"Big sorrow",
  WRITE:"Put into words",
  WROTE:"Put into words, once",
  YEA:"Supportive vote",
  YELL:"Shout it out",
  YEP:"Casual yes",
  YET:"So far, still",
...
// Apply overrides — these replace any existing FILL_CLUES entry for a warmer, Mini-appropriate feel
Object.assign(FILL_CLUES, CLUE_OVERRIDES);
...
const BLOCKED_WORDS = new Set([
  ...
  // ---- Batch 4: bad crosswordy fill + wedding-unfriendly words ----
  // Too obscure / old-fashioned crosswordy for this vibe:
  'AEGIS','AERIE','ALAR','ALEE','ARS','EYRIE','ODEON','OGEE','SAPA','YAR','BEGAT',
  // Not wedding-site-friendly:
  'ABUSE','ARSON','BULLY','DRUNK','GRAVE','HATE','IDIOT','VENOM',
...
// Note: ATTA, STELA, ATMA, ERS removed from unblock list — keeping them blocked per clue quality audit
for (const word of ["SEA","SER","RET","EER","BUTTE","EDEMA","EROS","AGHA","EAN","ESS","NEEP"]) {
...
// Also skip any word in BLOCKED_WORDS so that explicit blocks apply to the curated pool too.
for (const word of ALL_CLUE_WORDS) {
  const len = word.length;
  if (WORDS_BY_LEN[len] !== undefined && /^[A-Z]+$/.test(word) && !BLOCKED_WORDS.has(word)) WORDS_BY_LEN[len].push(word);
}
