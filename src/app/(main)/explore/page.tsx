        ...
        <div>
            ...
            <Section background="surface" className="text-center pb-14 pt-12 md:pb-16 md:pt-16">
                <p className="mb-4 text-[11px] uppercase tracking-[0.3em] text-accent md:text-xs">
                    Nearby &amp; Worth the Trip
                </p>
                <h1 className="font-heading text-4xl md:text-6xl mb-6">Explore</h1>
            ...
            <Section background="base" spacing="tight">
                <div className="max-w-5xl mx-auto">

                    {/* State Fair callout */}
                    <div className="mb-10 rounded-[4px] border border-accent/30 bg-accent/10 p-6 flex flex-col md:flex-row gap-5 items-start md:p-8">
                        <div className="shrink-0 w-12 h-12 rounded-full bg-accent/15 flex items-center justify-center text-accent">
                            <Star size={22} strokeWidth={1.5} />
                        </div>
                        <div className="flex-1">
                            <p className="text-xs font-semibold uppercase tracking-widest text-accent mb-1">Happening Wedding Weekend</p>
                            <h3 className="font-heading text-xl text-primary mb-2">State Fair of Texas — at Fair Park</h3>
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-1.5 text-sm font-medium text-primary underline decoration-accent underline-offset-4 hover:text-accent transition-colors"
                            >
                                <ExternalLink size={13} />
                                bigtex.com — Plan Your Visit
                            </a>
                            <p className="text-xs text-text-secondary mt-2">Tip: Take the DART Green Line to Fair Park Station — parking gets wild on weekends.</p>
                        </div>
                    </div>
                    ...
                    <li key={item.name} className="flex flex-col gap-0.5 py-1">
