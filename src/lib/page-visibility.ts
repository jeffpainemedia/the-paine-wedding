...
export const MANAGED_PAGES = [
    ...
    { slug: "schedule",        label: "Wedding Day" },
...
export const PUBLIC_NAV_LINKS = [
    ...
    { name: "Schedule", href: "/schedule", managedSlug: "schedule" as ManagedPageSlug },
...
export const PUBLIC_FOOTER_LINKS = [
    ...
    { label: "Schedule", href: "/schedule", managedSlug: "schedule" as ManagedPageSlug },
